...
$filterdata = array_filter($databarang, function ($d) {
    return $d['Status'] === "ada di gudang";
})
?>

<div class="p-6">
    <div class="overflow-x-auto rounded-[10px] mt-3">
    <h1 class=" text-2xl mb-2  font-bold ">Di Dalam Gudang</h1>
                    ...
                    <tr class="text-sm">
                        ...
                        <td class="p-2">
                            <div class="flex justify-center space-x-2">
                                <button data-modal-target="#modal-konfirmasi-<?= $d['id_barang'] ?>" class="flex relative px-5 py-2 text-white font-bold bg-blue-500 rounded-lg shadow-lg transition-all duration-300 transform active:translate-y-1 hover:shadow-none">
                                    <i class="bi bi-pencil-fill me-1"></i> Perubahan 
                                </button>
